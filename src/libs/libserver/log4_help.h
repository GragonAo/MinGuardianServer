...
#define LogColorRed        31 // 红色
#define LogColorGreen      32 // 绿色
#define LogColorYellow     33 // 黄色
#define LogColorBlue       34 // 蓝色
#define LogColorPurple     35 // 紫色
#define LogColorCyan       36 // 青色

#define LogColorGrey       90 // 深灰色

#define LogColorRedEx      91 // 浅红色
#define LogColorGreenEx    92 // 浅绿色
#define LogColorYellowEx   93 // 浅黄色
#define LogColorBlueEx     94 // 浅蓝色
#define LogColorPurpleEx   95 // 浅紫色
#define LogColorCyanEx     96 // 浅青色

#endif

// Windows平台下设置控制台文本颜色的函数声明
#if ENGINE_PLATFORM == PLATFORM_WIN32
